        ...
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('employeeIndex') }}" style="color: #007bff;">Control Employee</a></li>
                ...
                <form action="{{ route('employeeCreate') }}" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-6 mb-2">
                            ...
                            name="phone" id="phone" placeholder="998-90-123-45-67" value="{{ old('phone') }}" 
