        ...
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('driverIndex') }}" style="color: #007bff;">Edit Driver</a></li>
                ...
                <form action="{{ route('driverUpdate', $driver->id) }}" method="post">
                    ...
                    <div class="row">
                        <div class="col-12 mb-2">
                            ...
                            name="full_name" id="full_name" placeholder="Full Name" value="{{ old('full_name', $driver->full_name) }}" required>
                        ...
                        <div class="col-12 col-lg-6 mb-2">
                            ...
                            id="track_num" placeholder="AA 077 F" value="{{ old('track_num', $driver->track_num) }}" required>
                        </div>
                        ...
                        <div class="col-12 col-lg-6 mb-2">
                            ...
                            <select class="form-control select2" style="width: 100%;" name="company_id"
                                ...
                                @foreach($companies as $company)
                                    <option value="{{$company->id}}" {{$company->id == $driver->company_id ? 'selected' : ''}}>{{$company->name}}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="col-12 col-lg-6 mb-2">
                            ...
                            id="eastern_time" placeholder="Time Zone" value="{{ old('eastern_time', $driver->eastern_time) }}" required>
                        </div>

                        <div class="col-12 col-lg-6 mb-2">
                            <label for="phone" class="col-form-label">Phone number</label>
                            <input class="form-control" type="number" 
                            name="phone" id="phone" placeholder="Phone number" value="{{ old('phone', $driver->phone) }}">
                        </div>

                        <div class="col-12 mb-2">
                            <label for="comment" class="col-form-label">Comment</label>
                            <textarea class="form-control" name="comment" cols="10"
                            placeholder="About">{{ $driver->comment }}</textarea>
                        </div>
                    </div>
