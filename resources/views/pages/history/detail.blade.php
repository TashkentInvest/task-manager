...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">Request History Info - {{ $currentTask->company->name ?? 'Deleted' }}</h4>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="btn-group float-right" role="group" aria-label="Basic example">
                    ...
                    <a href="{{ route('historyDetailIndex',['id' => $id]) }}" class="btn btn-secondary waves-effect waves-light btn-sm">
                    ...
                    <tbody>
                        @foreach($tasks as $task)
                            <tr>
                                ...
                                <td>
                                    @if($task->new_status_id == 2 || $task->new_status_id == 5)
                                        <span class="badge rounded-pill bg-danger" style="font-size: 14px;">{{ $task->status->name }}</span> 
                                    @elseif($task->new_status_id == 1 || $task->new_status_id == 3 || $task->new_status_id == 4)
