                ...
                <form action="{{ route('categoryUpdate', $category->id) }}" method="post">
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-6 mb-2">
                            ...
                            name="name" id="name" placeholder="Name" value="{{ old('name', $category->name) }}" required>
                            @if($errors->has('name'))
                        ...
                        <div class="col-12 col-lg-6 mb-2">
                            ...
                            name="score" id="count" 
                            placeholder="Enter score" value="{{ old('score', $category->score) }}" required>
                        </div>
                        <div class="col-12 col-lg-6 mb-2">
                            <label for="deadline" class="col-form-label">Deadline</label>
                            <input class="form-control" type="number" name="deadline" 
                            id="deadline" placeholder="Type between 1 and 60" max="60" value="{{ old('deadline', $category->deadline) }}" required>
                        </div>
                        <div class="col-12 col-lg-6 mb-2">
                            ...
                            value="{{ old('additional_time', $category->additional_time) }}">
                        </div>
                    </div>
