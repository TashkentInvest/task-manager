...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">Add Long text</h4>

            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="{{ route('home') }}" style="color: #007bff;">@lang('global.home')</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('longTextIndex') }}" style="color: #007bff;">Control Long Text</a></li>
    ...
    <div class="col-lg-10 offset-lg-1 col-sm-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('longTextCreate') }}" method="post">
                    @csrf
                    <div class="row">
                        <div class="col-12 mb-2">
                            <label for="category" class="col-form-label">Category</label>
                            <input class="form-control {{ $errors->has('category') ? 'is-invalid' : '' }}" type="text" 
                            name="category" id="category" placeholder="Category" value="{{ old('category') }}" required>
                        ...
                        <div class="col-12 mb-2">
                            ...
                            placeholder="About" required>{{ old('description') }}</textarea>
                        </div>
                    </div>
