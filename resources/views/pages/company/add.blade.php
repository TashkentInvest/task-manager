...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">Add Control Company</h4>
                ...
                <form action="{{ route('companyCreate') }}" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-6 mb-2">
                            ...
                            placeholder="Owner name" value="{{ old('owner_name') }}" required>
                        </div>
                        <div class="col-12 col-lg-6 mb-2">
                            <label for="phone" class="col-form-label">Phone number</label>
                            <input class="form-control" type="number" 
                            name="phone" id="phone" placeholder="Phone number" value="{{ old('phone') }}" required>
                        </div>
                    </div>
