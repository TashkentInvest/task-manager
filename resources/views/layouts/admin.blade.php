			    ...
			    <div class="d-flex">
					...
					<div class="d-flex align-items-center">
						...
						@php
							...
							$totalScore = Rating::where('user_id', auth()->user()->id)->where('action', 0)->sum('score') - Rating::where('user_id', auth()->user()->id)->where('action', 1)->sum('score')  ;
				...
				<div class="d-flex">
					...
					<div class="d-flex align-items-center">
						<div class="square-switch d-flex">
							...
							onclick="toggle_instock({{ auth()->user()->id  }})" {{ auth()->user()->is_online ? 'checked' : '' }} />
							<label for="user_{{ auth()->user()->id }}" class="mb-0 employee-switch-status" data-on-label="Online"
								data-off-label="Offline"></label>
						</div>
					</div>
					@endif
					...
					<div class="dropdown d-inline-block">
						...
						<div class="dropdown-menu dropdown-menu-end">
							...
							@if(auth()->user())
								<a class="dropdown-item d-block" href="{{ route('userProfile',auth()->user()->id) }}">
			...
			<footer class="footer">
				<div class="container-fluid">
					<div class="row d-flex align-items-center">
						<div class="col-sm-4">
						    <strong>Copyright &copy; {{ date('Y') }} <a href="#!">TeamDevs-Group </a>.</strong>
			                All rights reserved.
						</div>
						<div class="col-sm-4">
							<div class="row p-0 m-0">
								...
								<div class="col-4">
									<div class="mt-4">
										<p class="mb-2 text-truncate"><i class="mdi mdi-circle text-warning me-1"></i> First task</p>
									</div>
								</div>

								<div class="col-4">
									<div class="mt-4">
										<p class="mb-2 text-truncate"><i class="mdi mdi-circle text-secondary me-1"></i> Later Task</p>
									</div>
								</div>
								
								<div class="col-4">
									<div class="mt-4">
										<p class="mb-2 text-truncate"><i class="mdi mdi-circle text-danger me-1"></i> Extra task</p>
									</div>
								</div>
							</div>
						</div>
